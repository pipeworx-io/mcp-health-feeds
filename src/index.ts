...
const FEEDS: Record<string, FeedDef> = {
  ...
  'nature-medicine': { title: "Nature Medicine", url: "https://www.nature.com/nm.rss", category: "health", source: "Nature Medicine", description: "Biomedical research." },
  'health-affairs': { title: "Health Affairs", url: "https://www.healthaffairs.org/action/showFeed?type=etoc&feed=rss&jc=hlthaff", category: "health", source: "Health Affairs", description: "Health policy research." },
  'fierce-biotech': { title: "Fierce Biotech", url: "https://www.fiercebiotech.com/rss/xml", category: "health", source: "Fierce Biotech", description: "Biotech industry news." },
};
